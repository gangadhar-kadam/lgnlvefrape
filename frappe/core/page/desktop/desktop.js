...
frappe.desktop.render = function() {
	...
	$('<div id = "ticker" width="100%"></div>').appendTo($('#icon-grid'))
...
frappe.desktop.show_ticker = function(){
	frappe.call({
		method: 'frappe.core.page.mail_ticker_manager.mail_ticker_manager.get_ticker',
		args:{'user':user},
		callback: function(r){
...
frappe.desktop.hide_ticker = function(){
	frappe.call({
		method: "frappe.core.page.mail_ticker_manager.mail_ticker_manager.hide_ticker",
		args: {'user': user},
		callback: function(r){
			frappe.desktop.refresh()
		}
